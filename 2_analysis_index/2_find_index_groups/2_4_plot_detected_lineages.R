...
########################################################################################################################################
pdf('2_analysis_index/2_find_index_groups/Index_SSonnei_with_groups_20251218.pdf', width = 7/2.54, height = 5/2.54, fonts = 'Arial', pointsize = 12)
...
write.tree(tree, file = 'Tree_SSonnei_full_20251218.tree')
write.csv(dataset_with_nodes, file = 'dataset_with_nodes_20251218.csv')

########################################################################################################################################
## Plot with groups pMSM and non-pMSM, group from full phylogeny
########################################################################################################################################
pdf('2_analysis_index/2_find_index_groups/Index_SSonnei_with_groups_20251218_non_pMSM_groupsALL_2000.pdf', width = 8/2.54, height = 5/2.54, fonts = 'Arial', pointsize = 12)
...
ggsave(filename = '2_analysis_index/2_find_index_groups/Fit_Index_SSonnei_with_groups_20251218.pdf',
