########################################################################################################################################
## Plot index: input: Initial_index_computation_and_parameters_20251218.Rdata
########################################################################################################################################
## Packages used
library(stringr)
library(ape)
...
########################################################################################################################################
pdf('2_analysis_index/1_index_computations/Index_SSonnei_UK_20251218.pdf', width = 6/2.54, height = 6/2.54)
...
########################################################################################################################################
pdf('2_analysis_index/1_index_computations/Index_SSonnei_UK_20251218_non_pMSM.pdf', width = 10/2.54, height = 5/2.54)
...
########################################################################################################################################
pdf('2_analysis_index/1_index_computations/Index_SSonnei_UK_20251218_travel.pdf', width = 10/2.54, height = 5/2.54)
par(mfcol = c(2,2), oma = c(0,0,0,0.5), mar = c(1,1,0,0), mgp = c(0,0.1,0), family = 'Arial',
    cex.axis=0.3, cex.lab=0.3, cex.main=0.4, cex.sub=0.3)
...
########################################################################################################################################
pdf('2_analysis_index/1_index_computations/Index_SSonnei_UK_20251218_simplified.pdf', width = 6/2.54, height = 6/2.54)
par(mfcol = c(2,1), oma = c(0,0,0,0.5), mar = c(1,1,0,0), mgp = c(0,0.1,0), family = 'Arial',
    cex.axis=0.3, cex.lab=0.3, cex.main=0.4, cex.sub=0.3)
...
########################################################################################################################################
pdf('2_analysis_index/1_index_computations/Index_SSonnei_UK_20251218_non_pMSM_simplified.pdf', width = 10/2.54, height = 5/2.54)
par(mfcol = c(2,2), oma = c(0,0,0,0.5), mar = c(1,1,0,0), mgp = c(0,0.1,0), family = 'Arial',
    cex.axis=0.3, cex.lab=0.3, cex.main=0.4, cex.sub=0.3)
