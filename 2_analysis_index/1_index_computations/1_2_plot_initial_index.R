########################################################################################################################################
## Plot index: input: Initial_index_computation_and_parameters_20251007.Rdata
########################################################################################################################################
## Packages used
library(stringr)
library(ape)
...
########################################################################################################################################
pdf('2_analysis_index/1_index_computations/Index_SSonnei_UK_20251007.pdf', width = 6/2.54, height = 6/2.54)
...
########################################################################################################################################
## Plot same dynamics for STN and non-STN, with colors from full genotypes
########################################################################################################################################
pdf('2_analysis_index/1_index_computations/Index_SSonnei_UK_20251007_non_STN.pdf', width = 10/2.54, height = 5/2.54)
...
########################################################################################################################################
pdf('2_analysis_index/1_index_computations/Index_SSonnei_UK_20251007_non_pMSM.pdf', width = 10/2.54, height = 5/2.54)
par(mfcol = c(2,2), oma = c(0,0,0,0.5), mar = c(1,1,0,0), mgp = c(0,0.1,0), family = 'Arial',
    cex.axis=0.3, cex.lab=0.3, cex.main=0.4, cex.sub=0.3)
...
########################################################################################################################################
pdf('2_analysis_index/1_index_computations/Index_SSonnei_UK_20251007_MSM_pandemic.pdf', width = 6/2.54, height = 6/2.54)
par(mfcol = c(2,1), oma = c(0,0,0,0.5), mar = c(1,1,0,0), mgp = c(0,0.1,0), family = 'Arial',
    cex.axis=0.3, cex.lab=0.3, cex.main=0.4, cex.sub=0.3)
...
########################################################################################################################################
## Plot same dynamics for travel pMSM and travel STN, with colors from full genotypes
########################################################################################################################################
pdf('2_analysis_index/1_index_computations/Index_SSonnei_UK_20251007_travel.pdf', width = 10/2.54, height = 5/2.54)
par(mfcol = c(2,2), oma = c(0,0,0,0.5), mar = c(1,1,0,0), mgp = c(0,0.1,0), family = 'Arial',
    cex.axis=0.3, cex.lab=0.3, cex.main=0.4, cex.sub=0.3)
...
## Travel STN
tree = tree_travelSTN
dataset_with_nodes = dataset_with_nodes_travelSTN
root_height = min(dataset_with_nodes$time)
## Plot tree
tree_to_plot = tree
plot(tree_to_plot, show.tip.label = FALSE, edge.width = 0.15, edge.color = 'grey', 
...
axis(1, at = seq(min_year, max_year, 2), labels = seq(min_year, max_year, 2), lwd = 0.5, tck=-0.02, mgp = c(0,-0.4,0))
axis(2, las = 2, tck=-0.01, lwd = 0.5)
title(main="S. sonnei - travel STN", line=-0.5, outer = F)
title(ylab="Index", line=0.5, outer = F)
title(xlab="Time (years)", line=0, outer = F)
...
########################################################################################################################################
pdf('2_analysis_index/1_index_computations/Index_SSonnei_UK_20251007_simplified.pdf', width = 6/2.54, height = 6/2.54)
par(mfcol = c(2,1), oma = c(0,0,0,0.5), mar = c(1,1,0,0), mgp = c(0,0.1,0), family = 'Arial',
    cex.axis=0.3, cex.lab=0.3, cex.main=0.4, cex.sub=0.3)
...
########################################################################################################################################
## Plot same dynamics for STN and non-STN
########################################################################################################################################
pdf('2_analysis_index/1_index_computations/Index_SSonnei_UK_20251007_non_STN_simplified.pdf', width = 10/2.54, height = 5/2.54)
par(mfcol = c(2,2), oma = c(0,0,0,0.5), mar = c(1,1,0,0), mgp = c(0,0.1,0), family = 'Arial',
    cex.axis=0.3, cex.lab=0.3, cex.main=0.4, cex.sub=0.3)
...
########################################################################################################################################
pdf('2_analysis_index/1_index_computations/Index_SSonnei_UK_20251007_non_pMSM_simplified.pdf', width = 10/2.54, height = 5/2.54)
par(mfcol = c(2,2), oma = c(0,0,0,0.5), mar = c(1,1,0,0), mgp = c(0,0.1,0), family = 'Arial',
    cex.axis=0.3, cex.lab=0.3, cex.main=0.4, cex.sub=0.3)
...
########################################################################################################################################
pdf('2_analysis_index/1_index_computations/Index_SSonnei_UK_20251007_MSM_pandemic_simplified.pdf', width = 6/2.54, height = 6/2.54)
par(mfcol = c(2,1), oma = c(0,0,0,0.5), mar = c(1,1,0,0), mgp = c(0,0.1,0), family = 'Arial',
    cex.axis=0.3, cex.lab=0.3, cex.main=0.4, cex.sub=0.3)
